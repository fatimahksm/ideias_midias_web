...
import type {SectionItemPayload, SectionItemResponse} from '@/features/items/types';
import {
  deleteItemMedia,
  getItemMediaByItem,
  updateItemMedia
} from '../api';
import type {ItemMediaType, SectionItemMediaPayload, SectionItemMediaResponse} from '../types';
...
export default function ItemMediaManager({itemId}: Props) {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      await queryClient.invalidateQueries({queryKey: ['item-media', 'item', itemId]});
    },
    onError: (error) => {
