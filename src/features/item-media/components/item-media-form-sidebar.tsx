...
import type {ItemMediaFormValues} from '../schema';

type Props = {
  values: ItemMediaFormValues;
  linkedItem?: SectionItemResponse;
};

export function ItemMediaFormSidebar({values, linkedItem}: Props) {
        ...
        <div className="mt-4 grid gap-3">
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            <p className="mt-1 text-sm font-medium text-slate-800">
              {linkedItem?.titleEn || t('noItemLinked')}
            </p>
          </div>
