...
function createPopupContent(
  ...
  titleEl.className = 'text-sm font-bold text-[var(--color-text)]';
  ...
  if (address) {
    ...
    addressEl.className = 'text-xs leading-5 text-[var(--color-text-muted)]';
  ...
  if (googleMapsUrl && openInMapsLabel) {
    ...
    link.rel = 'noreferrer';
    link.className =
      'inline-flex items-center gap-2 rounded-xl bg-[var(--color-secondary)] px-3 py-2 text-xs font-semibold text-white transition hover:bg-slate-800';
